  ...
  return (
    ...
    {googleHref ? (
        ...
        >
          ...
          {/* THE shared Google entry — same block the request-access sheet
              renders, so the two flows are one piece of code. Its footnote
              covers the "new here" path (the same button starts a request). */}
          <GoogleSignInBlock
            href={googleHref}
            sub="Use your Google account — approved retailers see wholesale prices instantly."
            footnote="New here? The same button starts your access request."
          />
          {googleOnly ? null : (
